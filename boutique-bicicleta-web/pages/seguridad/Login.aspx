<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="boutique_bicicleta_web.Login" MasterPageFile="~/pages/master/default.Master" %>
				...
				<tr>
					<td align="center">
						<table border="0"  cellpadding="2" cellspacing="0" class="TablaContenedora"
							...
							<tr class="bgCabecera">
								<td width="67" valign="bottom" style="height: 23px"><div align="center"><img src="../images/mvfactory.gif" width="55" height="16"></div>
								</td>
							...
							<tr>
								<td height="150" colspan="2" align="center" valign="top"><fieldset>
										...
										<table width="280" border="0" align="center" cellpadding="0" cellspacing="0">
											...
											<tr>
												<td height="20" style="width: 180px"><div align="right"><span class="txt">Usuario:
															<asp:TextBox id="txtUsuario" runat="server" CssClass="campos"></asp:TextBox>&nbsp;
														</span>
													</div>
												</td>
												<td rowspan="3" valign="top" style="width: 100px"><div align="right"><img src="../../images/Profile.png" width="75" height="79" border="1"></div>
												</td>
											</tr>
											<tr>
												<td height="20" style="width: 180px"><div align="right"><span class="txt">Password:
							...
							<tr>
								<td colspan="2" align="center" valign="top"><span class="txtMenu">
										...
										- Bando software / todos los derechos reservados</span></td>
							</tr>
						</table>
						<div ><br></br>
						</div>
